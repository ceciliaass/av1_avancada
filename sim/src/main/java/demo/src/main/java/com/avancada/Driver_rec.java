...
public class Driver_rec extends Thread{
    Car_rec carro;
    private int conta;
    ...
    public Driver_rec(Car_rec carro, SumoTraciConnection sumo, String txtNome /*AlphaBank banco*/, int conta, int inf, int sup) throws IOException{
