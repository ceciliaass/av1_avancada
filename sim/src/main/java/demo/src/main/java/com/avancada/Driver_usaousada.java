...
//     public Driver(Car carro, SumoTraciConnection sumo, String txtNome /*AlphaBank banco*/, int conta, int inf, int sup, FuelStation posto) throws IOException{
...
//                         this.posto.addDriver(this);
//                         // Thread T1 = posto;
//                         // T1.start();
//                         //this.car.
//                         //System.out.println("CHEMEI A FUEL");
//                         // try {
//                         //     //Thread.sleep(200);
