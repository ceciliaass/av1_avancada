...
//     private ArrayList<Driver> clientes;

//     public FuelStation() throws IOException{
...
//                 System.out.println("TO NA FUEL");
//                 //abastecer
//                 try {
//                     clientes.get(0).setAbastecendo(true);
//                     Json json = new Json();
// 		            enviarMensagem(json.Json_versaldo(clientes.get(0).getConta()));
//                     //Thread.sleep(500);
...
//                clientes.get(0).getCar().setFuelTank(qtd_combustivel + clientes.get(0).getCar().getFuelTank());
//                clientes.get(0).setAbastecendo(false);
//                System.out.println(qtd_combustivel);
//                //sacar da conta do driver
//                clientes.get(0).setfuelDivida(this.conta, this.quant_abastecimento);
...
//     public synchronized void addDriver(Driver motorista){
