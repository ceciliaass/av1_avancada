	...
	Route (
		...
		addReadQuery(Variable.ROUTE, 
				new RouteQuery (dis, dos,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_GET_ROUTE_VARIABLE,
				id,
						sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.VAR_EDGES
				, repoEdge
